...
export default function SliderOne() {
  ...
  const slides = ["1ma.jpg", "2ma.jpg", "3ma.jpg"].map(publicAsset);
  ...
  return (
    <div className="mx-auto mt-4 w-full max-w-[1450px] px-4 sm:px-6">
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-3">
        <img className="w-full rounded-2xl" src={publicAsset("177.jpg")} alt="" />
        <img className="w-full rounded-2xl" src={publicAsset("277.jpg")} alt="" />
        <img className="w-full rounded-2xl" src={publicAsset("377.jpg")} alt="" />
      </div>
